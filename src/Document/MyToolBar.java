...
public class MyToolBar 
{
	...
	JButton refresh;
	JPanel panel;
	static MyToolBar folderToolBar;
	
	static public MyToolBar getToolBar()
	{
	...
	public MyToolBar()
	{
		...
		refresh=new JButton(new ImageIcon("resource/refresh.png"));
		refresh.setBorderPainted(false);
		refresh.setFocusPainted(false);
		searchPanel.add(refresh,BorderLayout.WEST);
	...
	ActionListener backButtonListener=new ActionListener()
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				setAddress("我的磁盘");
				ContentPanel.switchPanel(MyHome.getDiskPanel());
				return ;
			}
			else
			{
	...
	ActionListener refreshButtonListener=new ActionListener(){
		...
		public void actionPerformed(ActionEvent e) {
			...
			ContentPanel father = null;
			ContentPanel c=new ContentPanel(father);
			c.refresh();
		}
	...
	ActionListener searchButtonListener=new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if (contentPanel==null) contentPanel=MyHome.contentPanel;
	...
	ActionListener addressButtonListener=new ActionListener()
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (!str.substring(0, 5).equals("我的磁盘/"))
			{
				warningErrorAddress();
				return ;
			}
			str=str.substring(5);
			ContentPanel contentPanel=MyHome.contentPanel;
			...
			if (!str.isEmpty())
			{
				...
				if (!isFind)
				{
					JOptionPane.showMessageDialog(null, "无法找到记事本", "地址错误", JOptionPane.ERROR_MESSAGE, null);
				}
			}
		}
	};
